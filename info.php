...
if(isset($_POST['Eiffel'])) {
	$que="SELECT * FROM `information` WHERE pname='Eiffel Tower'";
	$result = mysqli_query($db, $que);
}
if(isset($_POST['colosseum'])) {
	$que="SELECT * FROM `information` WHERE pname='The Colosseum'";
	$result = mysqli_query($db, $que);
}
if(isset($_POST['SOL'])) {
	$que="SELECT * FROM `information` WHERE pname='Statue of Liberty'";
	$result = mysqli_query($db, $que);
}
...
if(isset($_POST['Petra'])) {
	$que="SELECT * FROM `information` WHERE pname='Petra'";
	$result = mysqli_query($db, $que);
}
...
if(isset($_POST['china'])) {
	$que="SELECT * FROM `information` WHERE pname='The Great Wall Of China'";
	$result = mysqli_query($db, $que);
}
...
if(isset($_POST['giza'])) {
	$que="SELECT * FROM `information` WHERE pname='The Pyramids of Giza'";
	$result = mysqli_query($db, $que);
}
